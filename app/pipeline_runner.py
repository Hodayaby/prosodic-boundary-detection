...
from pipeline.job_logging import StageEventCallback
...
def run_pipeline(
    ...
    Input: audio_path, transcript_csv_path - the uploaded files' local paths;
        ...
        on_stage_event - optional callback for live stage/SLURM-status
        updates, e.g. to drive a status display in the UI while this blocks.
